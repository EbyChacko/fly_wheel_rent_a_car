...
urlpatterns = [
    ...
    path('confirm_cancel_booking/<int:id>/', views.confirm_cancel_booking, name='confirm_cancel_booking'),
    path('confirm_delete_booking/<int:id>/', views.confirm_delete_booking, name='confirm_delete_booking'),
