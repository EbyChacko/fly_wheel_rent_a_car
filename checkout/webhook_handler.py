...
from cars.models import Title, County
            ...
            if booking_exists:
                ...
                try:
                    ...
                    booking = Booking.objects.create(
                        ...
                        booster_seat=request.session.get(
                            'booster_quantity', 0),
                        child_seat=request.session.get(
                            'childseat_quantity', 0),
                        infant_car_capsule=request.session.get(
                            'infant_quantity', 0),

                        booster_total=request.session.get('booster_total', 0),
                        childseat_total=request.session.get(
                            'childseat_total', 0),
